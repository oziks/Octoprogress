...
abstract class BaseUser extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the acces_token field.
     * @var        string
     */
    ...
    /**
     * Get the [acces_token] column value.
     *
     * @return string
     */
    ...
    /**
     * Set the value of [acces_token] column.
     *
     * @param string $v new value
     * @return User The current object (for fluent API support)
     */
    public function setAccesToken($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->acces_token !== $v) {
            $this->acces_token = $v;
            $this->modifiedColumns[] = UserPeer::ACCES_TOKEN;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->acces_token = ($row[$startcol + 9] !== null) ? (string) $row[$startcol + 9] : null;
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(UserPeer::ACCES_TOKEN)) {
            $modifiedColumns[':p' . $index++]  = '`ACCES_TOKEN`';
        }
        if ($this->isColumnModified(UserPeer::CREATED_AT)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`LOCATION`':
                        ...
                        break;
                    case '`ACCES_TOKEN`':
                        $stmt->bindValue($identifier, $this->acces_token, PDO::PARAM_STR);
                        break;
                    case '`CREATED_AT`':
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[9], $arr)) $this->setAccesToken($arr[$keys[9]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserPeer::ACCES_TOKEN)) $criteria->add(UserPeer::ACCES_TOKEN, $this->acces_token);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setAccesToken($this->getAccesToken());
